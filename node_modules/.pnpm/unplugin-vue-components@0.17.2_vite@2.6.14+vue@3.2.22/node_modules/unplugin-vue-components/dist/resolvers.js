...
// node_modules/.pnpm/@vueuse+core@6.1.0/node_modules/@vueuse/core/indexes.json
var require_indexes = _chunk7T67WII5js.__commonJS.call(void 0, {
  "node_modules/.pnpm/@vueuse+core@6.1.0/node_modules/@vueuse/core/indexes.json"(exports, module) {
    module.exports = {
      packages: {
        shared: {
          name: "shared",
...
function getStyleDir(compName) {
  ...
  if (!styleDir)
    styleDir = _chunkLWMWOXVQjs.kebabCase.call(void 0, compName);
  return styleDir;
}
...
function resolveComponent(name, options) {
  if (!name.match(/^El[A-Z]/))
    return;
  const partialName = _chunkLWMWOXVQjs.kebabCase.call(void 0, name.slice(2));
...
function ElementPlusResolver(options = {}) {
  const optionsResolved = _chunk7T67WII5js.__spreadValues.call(void 0, {
    ssr: false,
    version: _chunkLWMWOXVQjs.getPkgVersion.call(void 0, "element-plus", "1.1.0-beta.21"),
    importStyle: "css",
    directives: true
  }, options);
  return [
  ...
  return {
    ...
    resolve: (name) => {
      if (name.startsWith("El")) {
        ...
        const partialName = _chunkLWMWOXVQjs.kebabCase.call(void 0, compName);
  ...
  return {
    ...
    resolve: (name) => {
      if (name.match(/^Ix[A-Z]/)) {
        const { importStyle } = options;
        const compName = name.slice(2);
        const kebabCaseName = _chunkLWMWOXVQjs.kebabCase.call(void 0, compName);
    ...
    resolve: (name) => {
      ...
      if (name.startsWith("Van")) {
        ...
        return {
          ...
          path: "vant/es",
          sideEffects: importStyle ? `vant/es/${_chunkLWMWOXVQjs.kebabCase.call(void 0, partialName)}/style` : void 0
        };
      }
    }
  };
...
function getResolved(name, options) {
  ...
  if (importStyle || importCss) {
    if (importStyle === "less" || importLess)
      sideEffects.push(`@varlet/ui/es/${_chunkLWMWOXVQjs.kebabCase.call(void 0, name)}/style/less.js`);
    else
      sideEffects.push(`@varlet/ui/es/${_chunkLWMWOXVQjs.kebabCase.call(void 0, name)}/style`);
  }
  return {
    path: "@varlet/ui",
...
var formatters = {
  "kebab-case": _chunkLWMWOXVQjs.kebabCase,
  "camelCase": _chunkLWMWOXVQjs.camelCase,
  "PascalCase": _chunkLWMWOXVQjs.pascalCase
};
var peerPaths = new Map();
function assertPeerPath(peerPath) {
  if (!peerPaths.has(peerPath)) {
    try {
      _chunkLWMWOXVQjs.resolveImportPath.call(void 0, peerPath);
...
function getCompDir(compName) {
  ...
  for (let i = 0; i < total; i++) {
    ...
    if (compName.match(matcher.pattern)) {
      compPath = `${matcher.compDir}/${_chunkLWMWOXVQjs.kebabCase.call(void 0, compName)}.vue`;
      break;
    }
  }
  if (!compPath)
    compPath = _chunkLWMWOXVQjs.kebabCase.call(void 0, compName);
  return compPath;
}
...
exports.AntDesignVueResolver = AntDesignVueResolver; exports.ElementPlusResolver = ElementPlusResolver; exports.ElementUiResolver = ElementUiResolver; exports.HeadlessUiResolver = HeadlessUiResolver; exports.IduxResolver = IduxResolver; exports.LibraryResolver = _chunkLWMWOXVQjs.LibraryResolver; exports.NaiveUiResolver = NaiveUiResolver; exports.PrimeVueResolver = PrimeVueResolver; exports.QuasarResolver = QuasarResolver; exports.VantResolver = VantResolver; exports.VarletUIResolver = VarletUIResolver; exports.VeuiResolver = VeuiResolver; exports.ViewUiResolver = ViewUiResolver; exports.VueUseComponentsResolver = VueUseComponentsResolver; exports.VuetifyResolver = VuetifyResolver; exports.getResolved = getResolved; exports.tryLoadVeturTags = _chunkLWMWOXVQjs.tryLoadVeturTags;
