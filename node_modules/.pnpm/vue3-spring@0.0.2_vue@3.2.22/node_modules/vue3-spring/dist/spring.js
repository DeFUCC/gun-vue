...
function spring(springValue, props) {
    ...
    // if the sprint has more than one variable
        ...
        output = vue.reactive(springs);
    }
    // watch reactive variables changes
    if (vue.isReactive(springValue)) {
        vue.watchEffect(() => {
        ...
        vue.watchEffect(() => (output.value = springValue.value));
    }
    return output;
}
...
var SpringProvider = {
    ...
    setup(props, { slots }) {
        ...
        if (isNumber(props.to)) {
            vue.watchEffect(() => (output.value = props.to));
        }
        return () => slots === null || slots === void 0 ? void 0 : slots.default(output);
    },
};

exports.SpringProvider = SpringProvider;
