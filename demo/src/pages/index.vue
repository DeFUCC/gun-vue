...
.flex.flex-col
    .flex.flex-wrap.shadow-lg.m-2.p-4.rounded-3xl.bg-light-300
        ...
        .flex.flex-col.ml-8
            ...
            .flex.flex-col.-mx-2
                a.m-1.flex.items-center(href="docs/index.html" target="_blank")
                    la-book.mr-4.text-3xl
                    .text-xl JSDoc documentation
                a.m-1.flex.items-center(href="https://github.com/defucc/gun-vue" target="_blank")
                    la-github.mr-4.text-3xl
                    .text-xl Git monorepo
                a.m-1.flex.items-center(href="https://www.npmjs.com/org/gun-vue" target="_blank")
                    la-npm.mr-4.text-3xl
                    .text-xl NPM organization
</template>
