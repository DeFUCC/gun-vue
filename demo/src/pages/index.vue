...
.flex.flex-col
  .flex.flex-wrap.shadow-lg.m-2.p-4.rounded-3xl.bg-light-300
    ...
    .flex.flex-col.ml-8.max-w-120
      ...
      .my-2 All the data in the app is stored only on the client side - right in your browser. And it's reactively synced between all simultaneous visitors by Gun. Share a link to the page with your friend to have a more deep experience. 
