...
const _sfc_main = {
  ...
  setup(__props, { expose }) {
    expose();
    const ChatRoom = defineAsyncComponent(() => __vitePreload(() => import("./ChatMessage.es.js").then(function(n) {
      return n.ChatRoom;
    ...
    const ChatTopics = defineAsyncComponent(() => __vitePreload(() => import("./ChatTopics.es.js"), true ? ["ChatTopics.es.js","vendor.es.js","useDraw.es.js","useChat.es.js","useBackground.es.js","AccountAvatar.es.js","plugin-vue_export-helper.es.js","times.es.js","plus.es.js"] : void 0));
