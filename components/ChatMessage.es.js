import { openBlock, createElementBlock, createBaseVNode, withDirectives, vModelText, withKeys, withModifiers, createVNode, createCommentVNode, ref, onMounted, toRef, withCtx, Fragment, renderList, createBlock, normalizeStyle, TransitionGroup, watch, nextTick, toDisplayString, computed, useMediaQuery, onClickOutside, reactive, watchEffect, useCssVars, unref, forceGraph, useBrowserLocation, useClipboard, useShare, Editor, renderSlot, createTextVNode } from "./vendor.es.js";
...
const _sfc_main$5 = {
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { props, user: user2, project, editable, text, useUser, useProject, updateProjectField, toRef, ref, computed, watchEffect, MdEditor: Editor };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
};
