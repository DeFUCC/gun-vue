...
const Comp9 = defineAsyncComponent(() => import("./ProjectCard.story.es.js"));
const Comp10 = defineAsyncComponent(() => import("./ProjectList.story.es.js"));
const Comp11 = defineAsyncComponent(() => import("./GiftCard.story.es.js"));
const Comp12 = defineAsyncComponent(() => import("./GiftForm.story.es.js"));
const Comp13 = defineAsyncComponent(() => import("./GiftList.story.es.js"));
...
let files = [
  ...
  { "id": "src-project-projectcard-story-vue", "path": ["Project", "Card"], "story": { "id": "src-project-projectcard-story-vue", "title": "Card", "group": null, "layout": { "type": "single", "iframe": true }, "icon": "la:toolbox", "iconColor": null, "docsOnly": false, "variants": [{ "id": "src-project-projectcard-story-vue-0", "title": "Round", "icon": null, "iconColor": null }] }, "framework": "vue3", "index": 9, component: Comp9 },
  { "id": "src-project-projectlist-story-vue", "path": ["Project", "List"], "story": { "id": "src-project-projectlist-story-vue", "title": "List", "group": null, "layout": { "type": "single", "iframe": true }, "icon": "la:tools", "iconColor": null, "docsOnly": false, "variants": [{ "id": "src-project-projectlist-story-vue-0", "title": "Round", "icon": null, "iconColor": null }] }, "framework": "vue3", "index": 10, component: Comp10 },
  { "id": "src-gift-giftcard-story-vue", "path": ["Gift", "Card"], "story": { "id": "src-gift-giftcard-story-vue", "title": "Card", "group": null, "layout": { "type": "single", "iframe": true }, "icon": null, "iconColor": null, "docsOnly": false, "variants": [{ "id": "src-gift-giftcard-story-vue-0", "title": "Round", "icon": null, "iconColor": null }] }, "framework": "vue3", "index": 11, component: Comp11 },
  { "id": "src-gift-giftform-story-vue", "path": ["Gift", "Form"], "story": { "id": "src-gift-giftform-story-vue", "title": "Form", "group": null, "layout": { "type": "single", "iframe": true }, "icon": null, "iconColor": null, "docsOnly": false, "variants": [{ "id": "src-gift-giftform-story-vue-0", "title": "Round", "icon": null, "iconColor": null }] }, "framework": "vue3", "index": 12, component: Comp12 },
  { "id": "src-gift-giftlist-story-vue", "path": ["Gift", "List"], "story": { "id": "src-gift-giftlist-story-vue", "title": "List", "group": null, "layout": { "type": "single", "iframe": true }, "icon": null, "iconColor": null, "docsOnly": false, "variants": [{ "id": "src-gift-giftlist-story-vue-0", "title": "Round", "icon": null, "iconColor": null }] }, "framework": "vue3", "index": 13, component: Comp13 },
