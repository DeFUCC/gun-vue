<script setup>
import { useUser, SEA, generateRoomCerts, createRoom, useBackground } from '@composables';
...
<template lang='pug'>
.flex.flex-col.bg-cover.rounded-2xl.p-8.max-w-620px.bg-light-800(v-if="user.pub" :style="{ ...bg }")
  .flex
