...
<template>
  ...
  <div v-if="user.pub" class="wrapper">
    ...
    <div class="toolbar">
      ...
      <button class="toolbar-button" :class="{ active: currentMode === 'think' }" @click="setMode('think')">
        <div class="i-fluent-chat-sparkle-28-regular"></div>
      </button>
      <button class="toolbar-button" :class="{ active: currentMode === 'about' }" @click="setMode('about')">
    ...
    <div class="bottom-bar ">
      <textarea v-model="message" ref="textRef" class="message-input" :class="currentMode" :placeholder="currentMode === 'default'
          ? ''
          : currentMode === 'think'
            ? '  '
            : '  '
      ...
      <button v-if="currentMode !== 'default'" class="confirm-button" @click="handleConfirm">
